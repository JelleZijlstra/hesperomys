...
class ArticleCitationDetailsInner extends React.Component<ArticleCitationDetailsInnerProps> {
  render() {
    const {
      articleInner,
      relay,
...
> {
  ...
  renderInner(article: Omit<ArticleCitationDetails_article, "oid" | " $refType">) {
