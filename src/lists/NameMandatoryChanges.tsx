...
import { NameMandatoryChanges_name } from "./__generated__/NameMandatoryChanges_name.graphql";
import { NameMandatoryChanges_nameInner } from "./__generated__/NameMandatoryChanges_nameInner.graphql";
import { NameMandatoryChangesDetailQuery } from "./__generated__/NameMandatoryChangesDetailQuery.graphql";
...
const NameMandatoryChangesContainer = createPaginationContainer(
  NameMandatoryChangesInner,
  {
    nameInner: graphql`
  ...
  {
    getConnectionFromProps: (props) => props.nameInner.mandatoryChanges,
    ...
    query: graphql`
      query NameMandatoryChangesPaginationQuery(
        $count: Int!
        $cursor: String
        $oid: Int!
        $showLocationDetail: Boolean!
...
> {
  constructor(props: NameMandatoryChangesProps) {
    super(props);
    const {
      showLocationDetail,
      showCitationDetail,
  ...
  render() {
    ...
    if (
      ...
      return (
        <QueryRenderer<NameMandatoryChangesDetailQuery>
          environment={environment}
          query={graphql`
            query NameMandatoryChangesDetailQuery(
              $oid: Int!
              $showLocationDetail: Boolean!
              $showCitationDetail: Boolean!
              $showCollectionDetail: Boolean!
