...
import { ArticleLectotypeDesignations_article } from "./__generated__/ArticleLectotypeDesignations_article.graphql";
import { ArticleLectotypeDesignations_articleInner } from "./__generated__/ArticleLectotypeDesignations_articleInner.graphql";
import { ArticleLectotypeDesignationsDetailQuery } from "./__generated__/ArticleLectotypeDesignationsDetailQuery.graphql";
...
class ArticleLectotypeDesignationsInner extends React.Component<ArticleLectotypeDesignationsInnerProps> {
  render() {
    ...
    if (
      ...
      articleInner.lectotypeDesignations.edges.length === 0
    ) {
      return null;
    }
    return (
...
const ArticleLectotypeDesignationsContainer = createPaginationContainer(
  ArticleLectotypeDesignationsInner,
  {
  ...
  {
    getConnectionFromProps: (props) => props.articleInner.lectotypeDesignations,
    ...
    query: graphql`
      query ArticleLectotypeDesignationsPaginationQuery(
        $count: Int!
        $cursor: String
        $oid: Int!
        $showLocationDetail: Boolean!
...
class ArticleLectotypeDesignations extends React.Component<
  ArticleLectotypeDesignationsProps,
  {
    showLocationDetail: boolean;
    showCitationDetail: boolean;
    showCollectionDetail: boolean;
...
> {
  constructor(props: ArticleLectotypeDesignationsProps) {
    super(props);
    const {
      showLocationDetail,
      showCitationDetail,
  ...
  render() {
    ...
    if (
      ...
      return (
        <QueryRenderer<ArticleLectotypeDesignationsDetailQuery>
          environment={environment}
          query={graphql`
            query ArticleLectotypeDesignationsDetailQuery(
              $oid: Int!
              $showLocationDetail: Boolean!
              $showCitationDetail: Boolean!
              $showCollectionDetail: Boolean!
