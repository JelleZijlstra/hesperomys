...
import { NameSelectionsOfPriority_name } from "./__generated__/NameSelectionsOfPriority_name.graphql";
import { NameSelectionsOfPriority_nameInner } from "./__generated__/NameSelectionsOfPriority_nameInner.graphql";
import { NameSelectionsOfPriorityDetailQuery } from "./__generated__/NameSelectionsOfPriorityDetailQuery.graphql";
...
class NameSelectionsOfPriorityInner extends React.Component<NameSelectionsOfPriorityInnerProps> {
  render() {
    ...
    if (
      ...
      nameInner.selectionsOfPriority.edges.length === 0
    ) {
      return null;
    }
    const inner = (
...
const NameSelectionsOfPriorityContainer = createPaginationContainer(
  NameSelectionsOfPriorityInner,
  {
    nameInner: graphql`
  ...
  {
    getConnectionFromProps: (props) => props.nameInner.selectionsOfPriority,
    ...
    query: graphql`
      query NameSelectionsOfPriorityPaginationQuery(
        $count: Int!
        $cursor: String
        $oid: Int!
        $showLocationDetail: Boolean!
...
> {
  constructor(props: NameSelectionsOfPriorityProps) {
    super(props);
    const {
      showLocationDetail,
      showCitationDetail,
  ...
  render() {
    ...
    if (
      ...
      return (
        <QueryRenderer<NameSelectionsOfPriorityDetailQuery>
          environment={environment}
          query={graphql`
            query NameSelectionsOfPriorityDetailQuery(
              $oid: Int!
              $showLocationDetail: Boolean!
              $showCitationDetail: Boolean!
              $showCollectionDetail: Boolean!
