...
import { NameUnjustifiedEmendations_name } from "./__generated__/NameUnjustifiedEmendations_name.graphql";
import { NameUnjustifiedEmendations_nameInner } from "./__generated__/NameUnjustifiedEmendations_nameInner.graphql";
import { NameUnjustifiedEmendationsDetailQuery } from "./__generated__/NameUnjustifiedEmendationsDetailQuery.graphql";
...
class NameUnjustifiedEmendationsInner extends React.Component<NameUnjustifiedEmendationsInnerProps> {
  render() {
    ...
    if (
      ...
      nameInner.unjustifiedEmendations.edges.length === 0
    ) {
      return null;
    }
    const inner = (
...
const NameUnjustifiedEmendationsContainer = createPaginationContainer(
  NameUnjustifiedEmendationsInner,
  {
    nameInner: graphql`
  ...
  {
    getConnectionFromProps: (props) => props.nameInner.unjustifiedEmendations,
    ...
    query: graphql`
      query NameUnjustifiedEmendationsPaginationQuery(
        $count: Int!
        $cursor: String
        $oid: Int!
        $showLocationDetail: Boolean!
...
class NameUnjustifiedEmendations extends React.Component<
  NameUnjustifiedEmendationsProps,
  {
    showLocationDetail: boolean;
    showCitationDetail: boolean;
    showCollectionDetail: boolean;
...
> {
  constructor(props: NameUnjustifiedEmendationsProps) {
    super(props);
    const {
      showLocationDetail,
      showCitationDetail,
  ...
  render() {
    ...
    if (
      ...
      return (
        <QueryRenderer<NameUnjustifiedEmendationsDetailQuery>
          environment={environment}
          query={graphql`
            query NameUnjustifiedEmendationsDetailQuery(
              $oid: Int!
              $showLocationDetail: Boolean!
              $showCitationDetail: Boolean!
              $showCollectionDetail: Boolean!
