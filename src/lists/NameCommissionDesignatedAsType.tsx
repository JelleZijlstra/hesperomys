...
import { NameCommissionDesignatedAsType_name } from "./__generated__/NameCommissionDesignatedAsType_name.graphql";
import { NameCommissionDesignatedAsType_nameInner } from "./__generated__/NameCommissionDesignatedAsType_nameInner.graphql";
import { NameCommissionDesignatedAsTypeDetailQuery } from "./__generated__/NameCommissionDesignatedAsTypeDetailQuery.graphql";
...
class NameCommissionDesignatedAsTypeInner extends React.Component<NameCommissionDesignatedAsTypeInnerProps> {
  render() {
    ...
    if (
      !nameInner.commissionDesignatedAsType ||
      nameInner.commissionDesignatedAsType.edges.length === 0
    ) {
      return null;
    }
    const inner = (
...
const NameCommissionDesignatedAsTypeContainer = createPaginationContainer(
  NameCommissionDesignatedAsTypeInner,
  {
    nameInner: graphql`
  ...
  },
  {
    ...
    query: graphql`
      query NameCommissionDesignatedAsTypePaginationQuery(
        $count: Int!
        $cursor: String
        $oid: Int!
        $showLocationDetail: Boolean!
...
class NameCommissionDesignatedAsType extends React.Component<
  NameCommissionDesignatedAsTypeProps,
  {
    showLocationDetail: boolean;
    showCitationDetail: boolean;
    showCollectionDetail: boolean;
...
> {
  constructor(props: NameCommissionDesignatedAsTypeProps) {
    super(props);
    const {
      showLocationDetail,
      showCitationDetail,
  ...
  render() {
    ...
    if (
      ...
      return (
        <QueryRenderer<NameCommissionDesignatedAsTypeDetailQuery>
          environment={environment}
          query={graphql`
            query NameCommissionDesignatedAsTypeDetailQuery(
              $oid: Int!
              $showLocationDetail: Boolean!
              $showCitationDetail: Boolean!
              $showCollectionDetail: Boolean!
