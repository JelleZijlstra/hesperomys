...
class ArticleDefinitionDetailsInner extends React.Component<
  ArticleDefinitionDetailsInnerProps
> {
  render() {
    const {
      articleInner,
...
> {
  ...
  renderInner(
    article: Omit<ArticleDefinitionDetails_article, "oid" | " $refType">
  ) {
