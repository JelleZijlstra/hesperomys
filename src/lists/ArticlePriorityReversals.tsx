...
class ArticlePriorityReversalsInner extends React.Component<
  ArticlePriorityReversalsInnerProps
> {
  render() {
    const {
      articleInner,
...
> {
  ...
  renderInner(
    article: Omit<ArticlePriorityReversals_article, "oid" | " $refType">
  ) {
    const {
      title,
      hideTitle,
