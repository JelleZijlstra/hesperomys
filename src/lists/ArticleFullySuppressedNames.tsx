...
class ArticleFullySuppressedNamesInner extends React.Component<
  ArticleFullySuppressedNamesInnerProps
> {
  render() {
    const {
      articleInner,
...
> {
  ...
  renderInner(
    article: Omit<ArticleFullySuppressedNames_article, "oid" | " $refType">
  ) {
